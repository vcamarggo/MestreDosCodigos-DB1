...
class HmacOneTimePasswordGenerator {
    ...
    HmacOneTimePasswordGenerator() throws NoSuchAlgorithmException {
     ...
     *                       6 and 8, inclusive
     */
    private HmacOneTimePasswordGenerator(final int passwordLength) throws NoSuchAlgorithmException {
     ...
     */
    String generateOneTimePassword(final SecretKey secretKey, final long counter) throws InvalidKeyException {
        final Mac mac;
