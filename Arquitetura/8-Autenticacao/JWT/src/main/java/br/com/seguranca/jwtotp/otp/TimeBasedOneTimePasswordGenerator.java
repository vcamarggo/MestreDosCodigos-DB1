 ...
 */
class TimeBasedOneTimePasswordGenerator extends HmacOneTimePasswordGenerator {
     ...
     */
    private static final String TOTP_ALGORITHM_HMAC_SHA256 = "HmacSHA256";
     ...
     * happen except in cases of serious misconfiguration
     */
    private TimeBasedOneTimePasswordGenerator(final long timeStep, final TimeUnit timeStepUnit) throws NoSuchAlgorithmException {
